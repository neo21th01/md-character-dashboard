    ...
    IG_DATA = [
        {
            ...
            "ig": "@qianqian_0.0_",
            "ig_url": "https://www.instagram.com/qianqian_0.0_/",
            "color": "#FFB300",
            "status": "new",
            "followers": 331,
            "following": 0,
            ...
            "avg_comments": None,
            "last_post": None,
            "note": "最新帐号 @qianqian_0.0_，旧 @qianqian.hanfu / @lqq.u_u 已被 ban；2026-04-29 起 重新开始（贴文 6 / 影片 8）",
            "updated": "2026-04-29",
            "platforms": [
                ("📸 IG",       "https://www.instagram.com/qianqian_0.0_/"),
                ("🐦 X",        "https://x.com/lazypiggy520"),
                ("🎵 TikTok",   "https://www.tiktok.com/@lqq.u__u"),
                ("🔗 Linktree", "https://linktr.ee/qianqian_hanfu"),
                ("🔞 FansOne",  "https://fansone.co/lazypiggy520"),
                ("🔞 Patreon",  "https://www.patreon.com/cw/qianqian_hanfu"),
            ],
        },
        {
            "name": "王芷涵",
